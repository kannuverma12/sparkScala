object LearningScala1{
  ...
  val hello: String = "Na maste!"                 //> hello  : String = Na maste!
  println(hello)                                  //> Na maste!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Na maste!
  helloThere = hello + " There!"
  println(helloThere)                             //> Na maste! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Na maste!There!
  println(immutableHelloThere)                    //> Na maste!There!
  ...
  val piDouble = {pi*2}                           //> piDouble  : Double = 6.2831853
  println(f" pi double precision $piDouble%.3f")  //>  pi double precision 6.283
