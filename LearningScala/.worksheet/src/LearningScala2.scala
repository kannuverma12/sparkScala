object LearningScala2 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(146); 
  // Flow control
  
  // If / else syntax
  if (1 > 3) println("Impossible Not !") else println("The world makes sense.");$skip(96); 
