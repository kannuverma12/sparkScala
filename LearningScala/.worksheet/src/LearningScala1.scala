object LearningScala1{;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(129); 
  ...
  val hello: String = "Na maste!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(306); 
  ...
  println(f" pi double precision $piDouble%.3f")}
